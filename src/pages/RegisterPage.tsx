  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 -right-32 w-96 h-96 bg-pink-500/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 -left-32 w-96 h-96 bg-pink-500/5 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <h1 className="font-serif text-5xl text-white mb-6 leading-tight">
            Únete a<br />
            <span className="text-pink-500">Nuestra Plataforma</span>
          </h1>
